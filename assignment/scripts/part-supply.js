...
console.log('Removed the last value from the supplyChanges', supplyChanges);

// 5. A delivery of 25 more parts arrived. Add the value 25 to the end of the array
console.log('5. Add the value 25 into supplyChanges.');

addedItem = supplyChanges.push(25);

console.log('Add the value of 25 into supplyChanges', supplyChanges);
